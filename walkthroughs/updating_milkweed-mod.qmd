...
model_prediction <- predictMaxnet(selected_model_south, environmental_mask_south,
...
# Sample background points from the provided area
bg_env_values_north <- penvs_bgSample(
  occs = species_points_north, # occurence points
...
#Add extracted values to background points table
bg_env_values_north <- cbind(scientific_name = paste0("bg_", species_name), bg_env_values_north,
                            occID = NA, year = NA, institution_code = NA, country = NA,
                            state_province = NA, locality = NA, elevation = NA,
