...
map_pred_values <- getRasterVals(model_prediction, "cloglog") # change for different types
map_xfer_values <- getRasterVals(xfer_area_mod$xferArea,"cloglog")
...
xfre_legend_pal <- colorNumeric(suitability_pal, map_xfer_values, na.color = 'transparent')
xfer_raster_pal <- colorNumeric(suitability_pal, map_xfer_values, na.color = 'transparent')

leaflet() %>% 
  addProviderTiles(providers$Esri.WorldTopoMap) %>%
  addLegend_decreasing("bottomleft", pal = legendPal, values = map_xfer_values, layerId = "xfer",
