...
In the case that there is not enough data to run SDMs for some of the species, please refer to `maxent/Aerosa_sdm.qmd` as an example of how to join survey data with supplementary data from GBIF. 
