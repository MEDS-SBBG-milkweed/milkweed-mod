...
## sf_use_s2(FALSE)
lpnf_ownership <- ownership_mask[lpnf_polygon,]

ggplot() +
  geom_sf(data = lpnf_ownership, fill = "lightgreen") +
   geom_sf(data = lpnf_boundary,
          color = "darkgreen",
          fill = "transparent",
          lwd = 1)
...
#st_write(lpnf_ownership,
         here("~/../../capstone/milkweedmod/data/clean_data/lpnf_land_ownership/lpnf_land_ownership.shp"),
        append = FALSE)
