...
```{r}
canopy_final <- 1- (mask(canopy_rescaled, lpnf_boundary))

slope_final <- 1 - (mask(slope_rescaled, lpnf_boundary))

trails_final <- 1 - (mask(trails_rescaled, lpnf_boundary))

roads_final <- 1 - (mask(roads_rescaled, lpnf_boundary))
