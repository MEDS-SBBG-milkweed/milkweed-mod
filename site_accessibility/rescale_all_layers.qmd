...
slope_reproject_avg <- project(slope_rescaled, temp_rast, method = "average")
```
...
origin(slope_reproject_max)==origin(temp_rast)
```
...
slope_final <- 1 - (mask(slope_reproject_max, lpnf_boundary_buffered))

# trails_final <- 1 - (mask(trails_reproject, lpnf_boundary_buffered))

# raods_final <- 1 - (mask(roads_reproject, lpnf_boundary_buffered))
```


# Save everything in milkweedmod/clean_data/site_accessibility

```{r}
# writeRaster(canopy_final, here("~/../../capstone/milkweedmod/clean_data/site_accessibility/canopy_rescale.tif"))
# writeRaster(slope_final, here("~/../../capstone/milkweedmod/clean_data/site_accessibility/slope_rescale.tif"))
# writeRaster(trails_final, here("~/../../capstone/milkweedmod/clean_data/site_accessibility/trails_rescale.tif"))
# writeRaster(roads_final, here("~/../../capstone/milkweedmod/clean_data/site_accessibility/raods_rescale.tif"))
# writeRaster(ownership_rast, here("~/../../capstone/milkweedmod/clean_data/site_accessibility/ownership_rescale.tif"))
```
