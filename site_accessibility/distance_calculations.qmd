...
```{r}
#terra::writeRaster(trails_merge, here::here("~/../../capstone/milkweedmod/clean_data/site_accessibility/trails_distance_raster.tif"))
#terra::writeRaster(roads_merge, here::here("~/../../capstone/milkweedmod/clean_data/site_accessibility/roads_distance_raster.tif"))
...
## Rescale (put this in rescale doc)
