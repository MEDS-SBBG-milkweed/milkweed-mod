...
n36w122 <- rast(here(file_path, "USGS_13_n36w122_20130911.tif"))
n37w122 <- rast(here(file_path, "USGS_13_n37w122_20130911.tif"))
```

```{r}
# mosaic the tiles to get full area
dem <- mosaic(n35w119, n35w120, n35w121, n36w120, n36w121)
plot(dem)
```
