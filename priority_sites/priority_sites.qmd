...
# ---- Max Suitability Raster -----------------------------
max_suitable <- rast(here("~/../../capstone/milkweedmod/outputs/sdm_outputs/max_suitable_sdm.tif"))
...
max_reproject <- project(max_suitable, template_rast)
...
all_priority <- max_reproject * access_index
...
all_rescaled <- rescale_raster(all_priority)
...
# 
# writeRaster(all_rescaled, here("~/../../capstone/milkweedmod/outputs/priority_sites_outputs/all_priority.tif"), overwrite = TRUE)
```
