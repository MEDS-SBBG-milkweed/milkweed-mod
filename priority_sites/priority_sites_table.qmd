...
# ---- Accessibility Index ----
access_index <- raster(here("~/../../capstone/milkweedmod/outputs/site_accessibility_outputs/access_index_final.tif"))

# ---- Priority ----
californica_priority <- raster(here("~/../../capstone/milkweedmod/outputs/priority_sites_outputs/californica_priority.tif"))
eriocarpa_priority <- raster(here("~/../../capstone/milkweedmod/outputs/priority_sites_outputs/eriocarpa_priority.tif"))
erosa_priority <- raster(here("~/../../capstone/milkweedmod/outputs/priority_sites_outputs/erosa_priority.tif"))
vestita_priority <- raster(here("~/../../capstone/milkweedmod/outputs/priority_sites_outputs/vestita_priority.tif"))
```
...
```{r}
write_csv(priority_surveyed_accessibility, "~/../../capstone/milkweedmod/outputs/priority_sites_outputs/priority_datatable.csv")
```
