...
writeRaster(eriocarpa_model, here("outputs", "dashboard", "eriocarpa_sdm.tif"))
...
write_rds(model_Ac, here(base_dir, "outputs", "sdm_outputs", "eriocarpa_sdm.rda"))
```

Plotting
```{r}
eriocarpa_pred <- rast(here("outputs", "dashboard", "eriocarpa_sdm.tif"))
pal_habitat <- c("#FFFFFF", "#EFCCCC", "#DF9999", "#D06666", "#C03333", "#B00000")
mapPredVals_eriocarpa <- getRasterVals(eriocarpa_pred)
