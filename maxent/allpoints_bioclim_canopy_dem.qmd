---
title: "All species points bioclim canpoy"
format: html
---
...
lpnf_boundary <- st_read(here::here("~/../../capstone/milkweedmod/data/lpnf_boundary_data/lpnf_boundary/lpnf_boundary.shp"))
boundary_buffered <- st_read(here::here("~/../../capstone/milkweedmod/data/lpnf_boundary_data/lpnf_boundary_buffered/"))

# lpnf_path <- list.files(here::here("~/../../capstone/milkweedmod/data/lpnf_boundary_data/lpnf_boundary_buffered/"), full.names = TRUE)
# lpnf_shp <- list.files(here::here("~/../../capstone/milkweedmod/data/lpnf_boundary_data/lpnf_boundary_buffered/"), full.names = FALSE)
...
milkweed_points <- my_points %>%
  st_coordinates() %>%
  data.frame() %>%
  mutate(scientific_name = "Asclepias sp.") %>%
...
# # Generate user-defined background extent
# bgExt_Ac <- penvs_userBgExtent(
#   occs = occs_Ac,
#   bgShp_name = lpnf_shp,
#   bgShp_path = lpnf_path,
#   userBgBuf = 0.5)
...
#### Model transfer
https://rdrr.io/cran/wallace/man/xfer_userExtent.html
https://rdrr.io/cran/wallace/man/xfer_userEnvs.html
...
m  %>%
  ...
  leaflet::addLegend("bottomright", pal = legendPal, values = mapPredVals_Ac, layerId = "train",
            ...
            title = "Asclepias sp.<br>Predicted Suitability<br>(Training)") %>%
...
```{r}
here::here("~/../../capstone/milkweedmod/data/lpnf_boundary_data/lpnf_boundary/lpnf_boundary.shp")
```
