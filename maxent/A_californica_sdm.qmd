...
#writeRaster(californica_model, here("~/../../capstone/milkweedmod/outputs/sdm_outputs/californica_sdm.tif"), overwrite=TRUE)
#write_rds(model_Ac, here("~/../../capstone/milkweedmod/outputs/sdm_outputs/californica_sdm.rda"))
# writeRaster(californica_model, "outputs/dashboard/californica_sdm.tif")
```

```{r}
# update this file path [come back]
californica_pred <- rast(here("~/../../capstone/milkweedmod/outputs/sdm_outputs/californica_sdm.tif"))
pal_habitat <- c("#FFFFFF", "#EFCCCC", "#DF9999", "#D06666", "#C03333", "#B00000")
mapPredVals_californica <- getRasterVals(californica_pred) # change for different types
