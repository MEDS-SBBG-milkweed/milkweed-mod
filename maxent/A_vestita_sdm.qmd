...
This notebook contains code for running a MaxEnt SDM for *A. vestita* within the Los Padres National Forest boundary, model selection, model transfer, and mapping. 
