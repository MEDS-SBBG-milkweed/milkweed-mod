...
boundary <- st_read(here::here("~/../../capstone/milkweedmod/data/lpnf_boundary_data/lpnf_boundary/lpnf_boundary.shp"))
boundary_buffered <- here::here("~/../../capstone/milkweedmod/data/lpnf_boundary_data/lpnf_boundary_buffered/")
...
m  %>%
  addCircleMarkers(data = occs_Ac, lat = ~latitude, lng = ~longitude,
                   radius = 5, color = 'black', fill = TRUE, fillColor = "black",
