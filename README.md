...
<img src = "https://github.com/MEDS-SBBG-milkweed/milkweed-mod/blob/main/outputs/figs/A_californica_sdm.png" alt="Habitat suitability map for Asclepias californica within the Los Padres National Forest" width="400"> <img src = "https://github.com/MEDS-SBBG-milkweed/milkweed-mod/blob/main/outputs/figs/A_eriocarpa_sdm.png" alt="Habitat suitability map for Asclepias eriocarpa within the Los Padres National Forest" width="400"> 
<img src = "https://github.com/MEDS-SBBG-milkweed/milkweed-mod/blob/main/outputs/figs/A_erosa_sdm.png" alt="Habitat suitability map for Asclepias erosa within the Los Padres National Forest" width="400"> <img src = "https://github.com/MEDS-SBBG-milkweed/milkweed-mod/blob/main/outputs/figs/A_vestita_sdm.png" alt="Habitat suitability map for Asclepias vestita within the Los Padres National Forest" width="400">

*Habitat suitability maps for all four early-season milkweed species*

**Survey site accessibility map.** To identify how physically accessible each location in the LPNF is, we developed a novel survey site accessibility index. We created this based on factors that we and our client deemed important in measuring physical accessibility, including distance from trails, distance from roads, slope, vegetation density, and land ownership status. The distance from trails, distance from roads, slope, and vegetation density data layers were rescaled to a scale of 0 (lowest relative accessibility) to 1 (highest relative accessibility). The land ownership layer was used as a mask where a value of 1 indicates public land and a value of 0 indicates private land. All of the layers were then multiplied together to create a final map of site accessibility throughout the LPNF on a scale of 0 to 1.
<img src = "https://github.com/MEDS-SBBG-milkweed/milkweed-mod/blob/main/outputs/figs/canopy-index-layer.png" alt="Map of canopy cover (as a proxy for vegetation density) on a scale from 0 (least accessible, highly dense vegetation) in white to 1 (most accessible, bare ground) in dark blue within the Los Padres National Forest" width="400"> <img src = "https://github.com/MEDS-SBBG-milkweed/milkweed-mod/blob/main/outputs/figs/land-ownership-index-layer.png" alt="Map of land ownership within the Los Padres National Forest where 0, in white, indicates private land, and 1, in dark blue, indicates public land" width="400">
<img src = "https://github.com/MEDS-SBBG-milkweed/milkweed-mod/blob/main/outputs/figs/roads-index-layer.png" alt="Map of the distance to the nearest road rescaled to a scale of 0 (closest to a road) in white to 1 (farthest from a road) in dark blue within the Los Padres National Forest" width="400"> <img src = "https://github.com/MEDS-SBBG-milkweed/milkweed-mod/blob/main/outputs/figs/trails-index-layer.png" alt="Map of the distance to the nearest trail rescaled to a scale of 0 (closest to a trail) in white to 1 (farthest from a trail) in dark blue within the Los Padres National Forest" width="400">
<img src = "https://github.com/MEDS-SBBG-milkweed/milkweed-mod/blob/main/outputs/figs/slope-index-layer.png" alt="Map of slope rescaled to a scale of 0 (flat) in white to 1 (very steep) in dark blue within the Los Padres National Forest" width="400">
