...
dem_slope <- terra::terrain(dem, v = "slope", unit="radians")
dem_aspect <- terra::terrain(dem, v = "aspect", unit="radians")
# dem_roughness <- terra::terrain(dem, v = "roughness", unit="degrees")

# save rasters to data folder 
# writeRaster(dem_slope, here::here("~/../../capstone/milkweedmod/clean_data/dem/lpnf_slope.tif"), overwrite=TRUE)
# writeRaster(dem_aspect, here::here("~/../../capstone/milkweedmod/clean_data/dem/lpnf_aspect.tif"), overwrite=TRUE)
