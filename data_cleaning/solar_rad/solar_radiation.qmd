...
slope_crop <- crop(slope, bbox)
plot(slope_crop)
northness_crop <- crop(northness_rad, bbox)
plot(northness_crop, col = palette(brewer.pal(n = 9, name = "Greys")), main = "Northness - LPNF South Section")
```
